...
Configures a rectangle object. A rectangle can be drawn in one of the following ways:
 ...
 If used the option 3, origin and destination segment will correspond to the bottom side of the rectangle, and the height will be the height of the rectangle, resulting in a rotated rectangle.
 In other cases, the origin corresponds to the bottom left corner of the rectangle, and destination corresponds to the top right corner of the rectangle.
